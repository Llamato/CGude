...
public:
  ...
  virtual void init() override {
    ...
    const Vertex v3{ Vec3{36, 60, 0}, blue };
    ...
    const Vertex a{ Vec3{264, 588, 0}, red, Vec3{-1, -1, 1} };
    const Vertex b{ Vec3{588, 588, 0}, red, Vec3{0.5f, 0.5f, 1} };
    const Vertex c{ Vec3{588, 372, 0}, red, Vec3{-1, -1, 1} };
